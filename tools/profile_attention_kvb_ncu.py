...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Profile attention kv_b GEMV kernel with NCU.")
    parser.add_argument("--out-rows", type=int, default=4096)
    parser.add_argument("--in-cols", type=int, default=512)
    parser.add_argument("--block-row", type=int, default=32)
    parser.add_argument("--block-col", type=int, default=128)
